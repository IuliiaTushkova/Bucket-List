...
class __TwigTemplate_018d42dbdde67236cef82f7eb4139ff8ff94aa4de81523d12b308976f08c92fe extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <h3>Te voilà, ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 3, $this->source); })()), "user", [], "any", false, false, false, 3), "pseudo", [], "any", false, false, false, 3), "html", null, true);
        echo "</h3>
...
";
    ...
    {
        return array (  74 => 5,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% block main %}
    <h3>Te voilà, {{ app.user.pseudo }}</h3>

    <p>Ton mail : {{ app.user.email }}</p>
...
{% endblock %}
", "profile/profile.html.twig", "C:\\wamp64\\www\\TP\\templates\\profile\\profile.html.twig");
    }
}
